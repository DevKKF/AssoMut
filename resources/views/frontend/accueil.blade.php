            ...
            <div class="col-lg-10 col-xl-7">
                <div class="fs-14 text-white">
                    <div class="d-flex align-items-center gap-3" data-sal="fade" data-sal-duration="500" data-sal-delay="200" data-sal-easing="ease-in-out-sine">
                        <span><img src="{{ asset('frontend/assets/img/shape/bage-1.png') }}" alt=""></span>
                        <span>
                ...
                <h1 class="text-white mt-1" data-sal="fade" data-sal-duration="500" data-sal-delay="200" data-sal-easing="ease-in-out-sine">Fast
                    ...
                    <span class="d-none d-md-inline-block position-relative z-1">
                        <img src="{{ asset('frontend/assets/img/hero-title.png') }}" alt="image" class="img-fluid">
            ...
            <div class="col-xl-5">
                <div class="position-relative z-1">
                    ...
                    <div class="hero-1__map">
                        <img class="img-fluid hero-1__map-img" src="{{ asset('frontend/assets/img/shape/hero-map.png') }}" alt="image">
                                ...
                                <div class="hero-1__map-location-info">
                                    <div class="hero-1__map-location-info-btn">
                                        <div class="hero-1__map-location-info-btn-img">
                                            <img src="{{ asset('frontend/assets/img/flag-5.png') }}" alt="image" class="img-fluid">
                                        </div>
                                    ...
                                    <div class="hero-1__map-location-info-arrow">
                                        <img src="{{ asset('frontend/assets/img/shape/location-arrow.png') }}" alt="image" class="img-fluid">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="hero-1__map-location hero-1__map-location--3">
                            <div class="hero-1__map-location-dot">
                                <div class="hero-1__map-location-info">
                                    <div class="hero-1__map-location-info-btn">
                                        <div class="hero-1__map-location-info-btn-img">
                                            <img src="{{ asset('frontend/assets/img/flag-7.png') }}" alt="image" class="img-fluid">
                                        </div>
                                        <div class="hero-1__map-location-info-btn-text">
                                            Russia
                                        </div>
                        ...
                        <div class="hero-1__map-location hero-1__map-location--4">
                            <div class="hero-1__map-location-dot">
                                <div class="hero-1__map-location-info">
                                    <div class="hero-1__map-location-info-btn">
                                        <div class="hero-1__map-location-info-btn-img">
                                            <img src="{{ asset('frontend/assets/img/flag-8.png') }}" alt="image" class="img-fluid">
                                        </div>
                                        <div class="hero-1__map-location-info-btn-text">
                                            New York
                                        </div>
                        ...
                        <div class="hero-1__map-location hero-1__map-location--5">
                            <div class="hero-1__map-location-dot">
                                <div class="hero-1__map-location-info">
                                    <div class="hero-1__map-location-info-btn">
                                        <div class="hero-1__map-location-info-btn-img">
                                            <img src="{{ asset('frontend/assets/img/flag-9.png') }}" alt="image" class="img-fluid">
                                        </div>
                                        <div class="hero-1__map-location-info-btn-text">
                                            Brazil
                                        </div>
                        ...
                        <div class="hero-1__map-location hero-1__map-location--6">
                            <div class="hero-1__map-location-dot">
                                <div class="hero-1__map-location-info">
                                    <div class="hero-1__map-location-info-btn">
                                        <div class="hero-1__map-location-info-btn-img">
                                            <img src="{{ asset('frontend/assets/img/flag-10.png') }}" alt="image" class="img-fluid">
                                        </div>
                                        <div class="hero-1__map-location-info-btn-text">
                                            Hongkong
                                        </div>
                        ...
                        <div class="hero-1__map-location hero-1__map-location--7">
                            <div class="hero-1__map-location-dot">
                                <div class="hero-1__map-location-info">
                                    <div class="hero-1__map-location-info-btn">
                                        <div class="hero-1__map-location-info-btn-img">
                                            <img src="{{ asset('frontend/assets/img/flag-11.png') }}" alt="image" class="img-fluid">
                                        </div>
                                        <div class="hero-1__map-location-info-btn-text">
                                            Bangladesh
                                        </div>
                        ...
                        <div class="hero-1__map-location hero-1__map-location--8">
                            <div class="hero-1__map-location-dot">
                                <div class="hero-1__map-location-info">
                                    <div class="hero-1__map-location-info-btn">
                                        <div class="hero-1__map-location-info-btn-img">
                                            <img src="{{ asset('frontend/assets/img/flag-12.png') }}" alt="image" class="img-fluid">
                                        </div>
                                        <div class="hero-1__map-location-info-btn-text">
                                            India
                                        </div>
            ...
            <div class="col-12">
                ...
                <div class="d-flex justify-content-center align-items-center gap-6 flex-wrap flex-lg-nowrap">
                    <a href="#" class="d-inline-block" data-sal="slide-up" data-sal-duration="500" data-sal-delay="300" data-sal-easing="ease-in-out-sine">
                        <img src="{{ asset('frontend/assets/img/brand-1.png') }}" alt="image" class="img-fluid transition opacity-50 brand-img">
                    </a>
                    <a href="#" class="d-inline-block" data-sal="slide-up" data-sal-duration="500" data-sal-delay="400" data-sal-easing="ease-in-out-sine">
                        <img src="{{ asset('frontend/assets/img/brand-3.png') }}" alt="image" class="img-fluid transition opacity-50 brand-img">
                    </a>
                    <a href="#" class="d-inline-block" data-sal="slide-up" data-sal-duration="500" data-sal-delay="500" data-sal-easing="ease-in-out-sine">
                        <img src="{{ asset('frontend/assets/img/brand-2.png') }}" alt="image" class="img-fluid transition opacity-50 brand-img">
                    </a>
                    ...
                    <a href="#" class="d-inline-block" data-sal="slide-up" data-sal-duration="500" data-sal-delay="700" data-sal-easing="ease-in-out-sine">
                        <img src="{{ asset('frontend/assets/img/brand-4.png') }}" alt="image" class="img-fluid transition opacity-50 brand-img">
                    </a>
                ...
                <div class="card service-card-item shadow-sm rounded-3 h-100" data-sal="slide-up" data-sal-duration="400" data-sal-delay="100" data-sal-easing="ease-in-out-sine">
                    <div class="card-body px-md-7 py-md-8">
                        ...
                        <div class="d-flex gap-5 flex-wrap flex-sm-nowrap mt-6">
                            <div>
                                <img src="{{ asset('frontend/assets/img/service-icon-1.png') }}" alt="">
                            </div>
                            <div>
            ...
            <div class="col-lg-6 col-xl-4">
                <div class="card service-card-item shadow-sm rounded-3 h-100" data-sal="slide-up" data-sal-duration="450" data-sal-delay="150" data-sal-easing="ease-in-out-sine">
                    <div class="card-body px-md-7 py-md-8">
                        ...
                        <div class="d-flex gap-5 flex-wrap flex-sm-nowrap mt-6">
                            <div>
                                <img src="{{ asset('frontend/assets/img/service-icon-2.png') }}" alt="">
                            </div>
                            <div>
                                <p>WordPress Hosting prov environment tailored to the needs of WordPress
                ...
                <div class="card service-card-item shadow-sm rounded-3 h-100" data-sal="slide-up" data-sal-duration="500" data-sal-delay="200" data-sal-easing="ease-in-out-sine">
                    <div class="card-body px-md-7 py-md-8">
                        ...
                        <div class="d-flex flex-wrap flex-sm-nowrap gap-5 mt-6">
                            <div>
                                <img src="{{ asset('frontend/assets/img/service-icon-3.png') }}" alt="">
                            </div>
                            <div>
                                <p>WordPress Hosting prov environment tailored to the needs of WordPress
                                    websites optimized</p>
                ...
                <div class="card service-card-item shadow-sm rounded-3 h-100" data-sal="slide-up" data-sal-duration="450" data-sal-delay="150" data-sal-easing="ease-in-out-sine">
                    <div class="card-body px-md-7 py-md-8">
                        <div class="row align-items-center g-4">
                            <div class="col-md-4">
                                <img src="{{ asset('frontend/assets/img/service-img.png') }}" alt="" class="img-fluid">
                            </div>
                            <div class="col-md-8">
            ...
            <div class="col-lg-6 col-xl-6">
                <div class="card service-card-item shadow-sm rounded-3 h-100" data-sal="slide-up" data-sal-duration="500" data-sal-delay="200" data-sal-easing="ease-in-out-sine">
                    <div class="card-body px-md-7 py-md-8">
                        ...
                        <div class="d-flex flex-wrap flex-sm-nowrap gap-5 mt-6">
                            <div>
                                <img src="{{ asset('frontend/assets/img/service-icon-4.png') }}" alt="">
                            </div>
                            <div>
                                <p>WordPress Hosting prov environment tailored to the needs of WordPress
                                    websitesoptimized servers</p>
            ...
            <div class="row g-4">
                <div class="col-xl-3 col-md-6" data-sal="slide-up" data-sal-duration="500" data-sal-delay="200" data-sal-easing="ease-in-out-sine">
                    <div class="why-card px-6 py-9 rounded-3 transition">
                        <img src="{{ asset('frontend/assets/img/why-icon-1.png') }}" alt="image" class="img-fluid">
                        <img src="{{ asset('frontend/assets/img/why-icon-1-dark.png') }}" alt="image" class="img-fluid dark">
                ...
                <div class="col-xl-3 col-md-6" data-sal="slide-up" data-sal-duration="500" data-sal-delay="300" data-sal-easing="ease-in-out-sine">
                    <div class="why-card px-6 py-9 rounded-3 transition">
                        <img src="{{ asset('frontend/assets/img/why-icon-2.png') }}" alt="image" class="img-fluid">
                        <img src="{{ asset('frontend/assets/img/why-icon-2-dark.png') }}" alt="image" class="img-fluid dark">
                ...
                <div class="col-xl-3 col-md-6" data-sal="slide-up" data-sal-duration="500" data-sal-delay="400" data-sal-easing="ease-in-out-sine">
                    <div class="why-card px-6 py-9 rounded-3 transition">
                        <img src="{{ asset('frontend/assets/img/why-icon-3.png') }}" alt="image" class="img-fluid">
                        <img src="{{ asset('frontend/assets/img/why-icon-3-dark.png') }}" alt="image" class="img-fluid dark">
                ...
                <div class="col-xl-3 col-md-6" data-sal="slide-up" data-sal-duration="500" data-sal-delay="500" data-sal-easing="ease-in-out-sine">
                    <div class="why-card px-6 py-9 rounded-3 transition">
                        <img src="{{ asset('frontend/assets/img/why-icon-4.png') }}" alt="image" class="img-fluid">
                        <img src="{{ asset('frontend/assets/img/why-icon-4-dark.png') }}" alt="image" class="img-fluid dark">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-10 col-xl-8">
                <div class="bg-white p-3 shadow-lg rounded position-relative" data-sal="slide-up" data-sal-duration="500" data-sal-delay="200" data-sal-easing="ease-in-out-sine">
                    <img src="{{ asset('frontend/assets/img/video-bg.png') }}" alt="" class="img-fluid w-100">
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="bg-white p-7 shadow-sm rounded-3">
                            ...
                            <div class="d-flex align-items-center gap-4 mt-7">
                                <img src="{{ asset('frontend/assets/img/user-img-1.png') }}" alt="image" class="img-fluid">
                                <div>
                    ...
                    <div class="swiper-slide">
                        <div class="bg-white p-7 shadow-sm rounded-3">
                            ...
                            <p class="mt-3">The best thing we love about Hostcity is it does two way sync with Google Apps. It has helped us to better organize everything on track.</p>
                            <div class="d-flex align-items-center gap-4 mt-7">
                                <img src="{{ asset('frontend/assets/img/user-img-3.png') }}" alt="image" class="img-fluid">
                                <div>
                                    <h6 class="fs-16 mb-0">Lola Ross</h6>
                                    <small>Digital Marketing Director</small>
                                </div>
                    ...
                    <div class="swiper-slide">
                        <div class="bg-white p-7 shadow-sm rounded-3">
                            ...
                            <p class="mt-3">The best thing we love about Hostcity is it does two way sync with Google Apps. It has helped us to better organize everything on track.</p>
                            <div class="d-flex align-items-center gap-4 mt-7">
                                <img src="{{ asset('frontend/assets/img/user-img-4.png') }}" alt="image" class="img-fluid">
                                <div>
                                    <h6 class="fs-16 mb-0">Lola Ross</h6>
                                    <small>Digital Marketing Director</small>
                                </div>
                    ...
                    <div class="swiper-slide">
                        <div class="bg-white p-7 shadow-sm rounded-3">
                            ...
                            <p class="mt-3">The best thing we love about Hostcity is it does two way sync with Google Apps. It has helped us to better organize everything on track.</p>
                            <div class="d-flex align-items-center gap-4 mt-7">
                                <img src="{{ asset('frontend/assets/img/user-img-5.png') }}" alt="image" class="img-fluid">
                                <div>
                                    <h6 class="fs-16 mb-0">Lola Ross</h6>
                                    <small>Digital Marketing Director</small>
                                </div>
...
<section class="pt-60 pb-60">
    <div class="container">
        <div class="row align-items-center g-6">
            <div class="col-lg-6">
                <img src="{{ asset('frontend/assets/img/wp-hosting.png') }}" alt="image" class="img-fluid" data-sal="slide-up" data-sal-duration="500" data-sal-delay="200" data-sal-easing="ease-in-out-sine">
            </div>
        ...
        <div class="row">
            <div class="col-xl-7" data-sal="fade" data-sal-duration="500" data-sal-delay="200" data-sal-easing="ease-in-out-sine">
                <div class="single-blog-post">
                    <img src="{{ asset('frontend/assets/img/blog-1.png') }}" alt="image" class="img-fluid w-100">
